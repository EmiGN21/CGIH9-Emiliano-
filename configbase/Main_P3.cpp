...
void dibujarCubo(glm::vec3 posicion, glm::vec3 rotacion, glm::vec3 escala, GLint modelLoc)
{
	glm::mat4 model = glm::mat4(1);

	model = glm::translate(model, posicion);

	model = glm::rotate(model, rotacion.x, glm::vec3(1.0f, 0.0f, 0.0f));
	model = glm::rotate(model, rotacion.y, glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::rotate(model, rotacion.z, glm::vec3(0.0f, 0.0f, 1.0f));
 ...
 //
	...
	while (!glfwWindowShouldClose(window))
	{
	 ...
	 model = glm::scale(model, glm::vec3(1.0f, 1.0f, 1.0f));
		...
		////model = glm::mat4(1);
		////model = glm::translate(model, glm::vec3(-4.0f, -4.0f, 0.0f));
		////model = glm::rotate(model, 0.5f, glm::vec3(0.4f, 1.0f, 3.0f));
		...
		////model = glm::mat4(1);
		////model = glm::translate(model, glm::vec3(-4.0f, 4.0f, 0.0f));
		////model = glm::rotate(model, 0.5f, glm::vec3(5.0f, 1.0f, 7.0f));
		////model = glm::scale(model, glm::vec3(0.4f, 1.0f, 3.0f));
		////glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		////glDrawArrays(GL_TRIANGLES, 0, 36);
		////
